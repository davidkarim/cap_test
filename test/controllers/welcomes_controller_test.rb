...
class WelcomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post welcomes_url, params: { welcome: { address: @welcome.address, age: @welcome.age, name: @welcome.name } }
    end
  ...
  test "should update welcome" do
    patch welcome_url(@welcome), params: { welcome: { address: @welcome.address, age: @welcome.age, name: @welcome.name } }
